...
app.get("/api/creators", async (req, res) => {
  try {
    ...
    let query = supabase
      .from("creators")
      .select("id, name, platform, youtube_id, instagram_id, category, country, state, bio, avatar_letter, avatar_color, subscribers, tags, avg_rating, review_count, verified", { count: "exact" })
      .eq("status", "approved")
